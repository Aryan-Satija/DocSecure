...
export const Signup = () => {
  ...
  return (
    <div className={otpGenerated ? 'h-screen flex flex-col md:flex-row-reverse w-screen' : 'h-screen flex flex-col gap-4 p-4 justify-between items-center md:flex-row w-[100vw] ' }>
    {
      ...
      (<>
        <div className='w-full  md:h-full p-4 font-special flex flex-col md:justify-center gap-4'>
          <div className='text-4xl font-bold text-sky-400'>WELCOME</div>
          ...
          <div className='text-slate-950/80'>
            <div className='inline-flex gap-8 py-2 rounded-full px-2 bg-sky-400/20' >
          ...
          <div>
            <button onClick={(event)=>{submitHandler(event)}} className="w-full text-center bg-sky-400 text-richblack-900 cursor-pointer rounded-[8px] px-[24px] py-[12px] duration-200 hover:scale-95">SIGN UP</button>
          </div>
        </div>
